...
# Вводятся два списка (каждый с новой строки) из слов, записанных через пробел. Имеется функция, которая преобразовывает
# эти две строки в два списка слов и возвращает эти списки.
...
def get_dict(func):
    def inner(*args, **kwargs):
        return key, value for sp, value in
