...
print("Метод string.rfind() - нахождения индекса подстроки в строке справа - налево")
print(msg.rfind("br", 2))

print("Метод string.index() - нахождения индекса подстроки в строке")
print("Метод string.replace() - замена подстроки")
