...
[print(morze[i], end=' ') for i in input().lower()]

#
# Строку с Морзе скопировал со страницы с заданием
lst = "А    .-	М    --	Ш    ---- Б    -...	Н    -.	Щ    --.- В    .--	О    ---	Ъ    --.-- Г    --.	П    .--.	Ы    -.-- Д    -..	Р    .-.	Ь    -..- Е . (Ё)    .	С    ...	Э    ..-.. Ж    ...-	Т    -	Ю    ..-- З    --..	У    ..-	Я    .-.- И    ..	Ф    ..-. Й    .---	Х    .... К    -.-	Ц    -.-. Л    .-..	Ч    ---.".split()

# Создаем словарь
d = {v: lst[i + 1] for i, v in enumerate(lst) if i % 2 == 0}
# Добавил пробел
d[' '] = '-···-'
